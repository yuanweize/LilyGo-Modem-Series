...
![Speaker](./images/SPK.png)

* Connect a microphone and speaker to use the voice call function.
* Connect a 1W speaker to SPK+/SPK-
* Connect a condenser microphone to MIC+/MIC-
